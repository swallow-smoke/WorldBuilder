...
{
    [Serializable]
    public sealed class BioluminescenceEntry : IWorldDataEntry
    {
        ...
        public BioluminescenceEntry(Vector3 position, float radius, float intensity, Color color, string sceneObjectGlobalId = "")
        {
